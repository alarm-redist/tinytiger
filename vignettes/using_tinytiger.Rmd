...
A full list are available on the [`tinytiger` website](https://alarm-redist.github.io/tinytiger/index.html#supported-geographies).
...
`r paste0("* [", setdiff(ls("package:tinytiger"), c("county_fips_2020", "tt_cache_clear", "tt_cache_path", "tt_cache_size")), "()]", collapse="\n")`
